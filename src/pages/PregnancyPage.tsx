  ...
  const handleCreateRecord = async (e: React.FormEvent) => {
    ...
    try {
      const record: Omit<PregnancyRecord, 'id'> = {
        ...
        date: new Date().toISOString().split('T')[0],
        weight: recordData.weight ? Number(recordData.weight) : undefined,
        bloodPressure: recordData.bloodPressure,
        fundalHeight: recordData.fundalHeight ? Number(recordData.fundalHeight) : undefined,
        fetalHeartRate: recordData.fetalHeartRate ? Number(recordData.fetalHeartRate) : undefined,
  ...
  const handleCreatePrevious = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const data: Omit<PreviousPregnancy, 'id'> = {
        ...
        gestationWeeks: previousData.gestationWeeks ? Number(previousData.gestationWeeks) : undefined,
